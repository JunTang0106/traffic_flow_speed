...
from FS_ST_encoder_decoder import FS_ST_Transformer
...
if __name__ == '__main__':
    ...
    for batch_index, batch_data in enumerate(train_loader):
        ...
        encoder_inputs, decoder_inputs, labels = encoder_inputs.to(device), decoder_inputs.to(device), labels.to(device)
        ...
        # 捕获可能的错误
        try:
            flow_outputs, speed_outputs = net(encoder_inputs.permute(0, 2, 1, 3), decoder_inputs.permute(0, 2, 1, 3))
