...
class T_block_for_decoder(nn.Module):
    def __init__(self, embed_size, heads, time_num, dropout, forward_expansion):
        super(T_block_for_decoder, self).__init__()
...
class decoder_layer(nn.Module):
    def __init__(self, embed_size, heads, adj, time_num, cheb_K, dropout, forward_expansion, num_of_vertices):
        ...
        self.ST_block = ST_block(embed_size, heads, adj, cheb_K, dropout, forward_expansion, num_of_vertices)
        self.self_attn = T_block_for_decoder(embed_size, heads, time_num, dropout, forward_expansion)
        self.norm1 = nn.LayerNorm(embed_size)
        self.norm2 = nn.LayerNorm(embed_size)
