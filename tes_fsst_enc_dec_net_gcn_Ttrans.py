...
from FS_ST_enc_dec_gcn_Ttrans import FS_ST_Transformer
...
if __name__ == '__main__':
    ...
    for batch_index, batch_data in enumerate(train_loader):
        encoder_inputs, dec_input, labels = batch_data
        ...
        # 捕获可能的错误
        try:
            flow_outputs, speed_outputs = net(encoder_inputs.permute(0, 2, 1, 3), dec_input.permute(0, 2, 1, 3))
